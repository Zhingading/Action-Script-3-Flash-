package 
{
	...
	{	
		...
		override public function Enemy1()
		{
			_image = new Image (Assets.GRAPHIC_SHIP_ENEMY1);
			graphic = _image;
			type = "Enemy";			
			setHitbox( 100, 250, -32, -30);
			shootDelay = 0.7;
		}
		
		private var speedX:Number = 100;
		private var _health:int = 600;
