package 
{
	...
	{	
		...
		override public function Enemy3()
		{
			_image = new Image (Assets.GRAPHIC_SHIP_ENEMY3);
			graphic = _image;
			type = "Enemy";			
			setHitbox( 90, 150, -15, -30);
			shootDelay = 1;
		}
		
		private var speedX:Number = 340;
		private var _health:int = 120;
